...
export default function formViewHOC({
  ...
  class FormView extends React.Component {
    ...
    save(callback) {
      console.log('form-view save(callback)');
    ...
    cancel(callback) {
      console.log('form-view cancel(callback)');
      this.resetEventToOriginalState();
    ...
    goBack() {
      ...
      this.props.history.push(this.props.backPathOverride);
    }
    ...
    renderHeader() {
      const backText = this.props.shouldUseGoBack ? '' : (this.props.backTextOverride);
